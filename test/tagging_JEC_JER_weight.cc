...
void tagging_JEC_JER_weight(string filename, int JEC = 0, int JER = 0, bool Data = false){
	...
	if (CSV->at(i) > 0.8484){
	  ...
	  if (N_b == 3){
	    b3.SetPtEtaPhiM(ak4pt->at(i), (*ak4Eta)[i], (*ak4Phi)[i], (*ak4Mass)[i]);
            b_tag_SF->push_back(0.561694*((1.+(0.31439*b3.Pt()))/(1.+(0.17756*b3.Pt()))));
	  }
	  if (N_b == 4){
	    b4.SetPtEtaPhiM(ak4pt->at(i), (*ak4Eta)[i], (*ak4Phi)[i], (*ak4Mass)[i]);
            b_tag_SF->push_back(0.561694*((1.+(0.31439*b4.Pt()))/(1.+(0.17756*b4.Pt()))));
	  }
	  if (N_b == 5){
	    b5.SetPtEtaPhiM(ak4pt->at(i), (*ak4Eta)[i], (*ak4Phi)[i], (*ak4Mass)[i]);
            b_tag_SF->push_back(0.561694*((1.+(0.31439*b5.Pt()))/(1.+(0.17756*b5.Pt()))));
	  }
          if (N_b == 6){
            b6.SetPtEtaPhiM(ak4pt->at(i), (*ak4Eta)[i], (*ak4Phi)[i], (*ak4Mass)[i]);
            b_tag_SF->push_back(0.561694*((1.+(0.31439*b6.Pt()))/(1.+(0.17756*b6.Pt()))));
          }
	}
      }
