...
config.General.requestName = 'TprimeTprime_M-1300'
config.General.workArea = 'TprimeTprime_1300GeV'
...
config.Data.inputDataset = '/TprimeTprime_M-1300_TuneCUETP8M1_13TeV-madgraph-pythia8/vorobiev-B2GAnaFW_RunIISpring16MiniAODv2_25ns_v80x_v2p0-a5c23f9700079f8bc7b9d2b4fb46cf81/USER'
...
config.Site.blacklist = ['T2_US_Nebraska', 'T2_US_Vanderbilt']
