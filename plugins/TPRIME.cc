...
private:
  ...
  edm::EDGetTokenT<std::vector<float> > ak8CHSjetMassToken_;
  ...
  edm::EDGetTokenT<std::vector<float> > ak8CHSjetmuonEnergyFracToken_;
  ...
  edm::EDGetTokenT<std::vector<float> > ak8PuppijetMassToken_;
  ...
  edm::EDGetTokenT<std::vector<float> > ak8PuppijetmuonEnergyFracToken_;
  ...
  edm::EDGetTokenT<std::vector<float> > ak4CHSjetMassToken_;
  ...
  edm::EDGetTokenT<std::vector<float> > ak4CHSjetmuonEnergyFracToken_;
  ...
  edm::EDGetTokenT<std::vector<float> > ak4PuppijetMassToken_;
  ...
  edm::EDGetTokenT<std::vector<float> > ak4PuppijetmuonEnergyFracToken_;
  ...
  AK4UncertFile (iConfig.getParameter<string>("AK4UncertFile"))
{
  ...
  */
  ...
  if (Puppi){
    ...
    listOfHadVars.push_back("jetak8RawMassPuppi");
    ...
    listOfHadVars.push_back("jetak4RawMassPuppi");
  }
  ...
  listOfGenVars.push_back("Mom0ID");
  listOfGenVars.push_back("Mom1ID");
  ...
  tree_had->Branch("Event_Number", &Event_Number, "Event_Number/F");
  ...
  edm::InputTag ak8CHSjetMassTag("jetsAK8CHS", "jetAK8CHSMass", "b2gEDMNtuples");
  ...
  edm::InputTag ak8CHSjetmuonEnergyFracTag("jetsAK8CHS", "jetAK8PCHSmuonEnergyFrac", "b2gEDMNtuples");
  edm::InputTag ak8CHSjetchargedEmEnergyFracTag("jetsAK8CHS", "jetAK8PCHSchargedEmEnergy", "b2gEDMNtuples");
  ...
  edm::InputTag ak4CHSjetMassTag("jetsAK4CHS", "jetAK4CHSMass", "b2gEDMNtuples");
  ...
  edm::InputTag ak4CHSjetmuonEnergyFracTag("jetsAK4CHS", "jetAK4PCHSmuonEnergyFrac", "b2gEDMNtuples");
  edm::InputTag ak4CHSjetchargedEmEnergyFracTag("jetsAK4CHS", "jetAK4PCHSchargedEmEnergy", "b2gEDMNtuples");
  ...
  edm::InputTag ak8PuppijetMassTag("jetsAK8Puppi", "jetAK8PuppiMass", "b2gEDMNtuples");
  ...
  edm::InputTag ak8PuppijetmuonEnergyFracTag("jetsAK8Puppi", "jetAK8PuppimuonEnergyFrac", "b2gEDMNtuples");
  edm::InputTag ak8PuppijetchargedEmEnergyFracTag("jetsAK8Puppi", "jetAK8PuppichargedEmEnergy", "b2gEDMNtuples");
  ...
  edm::InputTag ak4PuppijetMassTag("jetsAK4Puppi", "jetAK4PuppiMass", "b2gEDMNtuples");
  ...
  edm::InputTag ak4PuppijetmuonEnergyFracTag("jetsAK4Puppi", "jetAK4PuppimuonEnergyFrac", "b2gEDMNtuples");
  edm::InputTag ak4PuppijetchargedEmEnergyFracTag("jetsAK4Puppi", "jetAK4PuppichargedEmEnergy", "b2gEDMNtuples");
  ...
  triggerNameTreeToken_ = consumes<std::vector<std::string> >(triggerNameTreeTag);
  METBitTreeToken_ = consumes<std::vector<float> >(METBitTreeTag);
  METNameTreeToken_ = consumes<std::vector<std::string> >(METNameTreeTag);
  ...
  if (!Puppi){
    ...
    ak8CHSjetMassToken_ = consumes<std::vector<float> >(ak8CHSjetMassTag);
    ...
    ak8CHSjetmuonEnergyFracToken_ =  consumes<std::vector<float> >(ak8CHSjetmuonEnergyFracTag);
    ...
    ak4CHSjetMassToken_ = consumes<std::vector<float> >(ak4CHSjetMassTag);
    ...
    ak4CHSjetmuonEnergyFracToken_ =  consumes<std::vector<float> >(ak4CHSjetmuonEnergyFracTag);
  ...
  if (Puppi){
    ...
    ak8PuppijetMassToken_ = consumes<std::vector<float> >(ak8PuppijetMassTag);
    ...
    ak8PuppijetmuonEnergyFracToken_ =  consumes<std::vector<float> >(ak8PuppijetmuonEnergyFracTag);
    ...
    ak4PuppijetMassToken_ = consumes<std::vector<float> >(ak4PuppijetMassTag);
    ...
    ak4PuppijetmuonEnergyFracToken_ =  consumes<std::vector<float> >(ak4PuppijetmuonEnergyFracTag);
...
TPRIME::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  */
  ...
  edm::Handle<vector<float> > triggerBitTreeHandle;
  edm::Handle<vector<string> > triggerNameTreeHandle;
  edm::Handle<vector<float> > METBitTreeHandle;
  ...
  edm::Handle<vector<float> > ak8CHSjetMassHandle;
  ...
  edm::Handle<vector<float> > ak8CHSjetmuonEnergyFracHandle;
  ...
  edm::Handle<vector<float> > ak4CHSjetMassHandle;
  ...
  edm::Handle<vector<float> > ak4CHSjetmuonEnergyFracHandle;
  ...
  edm::Handle<vector<float> > ak8PuppijetMassHandle;
  ...
  edm::Handle<vector<float> > ak8PuppijetmuonEnergyFracHandle;
  ...
  edm::Handle<vector<float> > ak4PuppijetMassHandle;
  ...
  edm::Handle<vector<float> > ak4PuppijetmuonEnergyFracHandle;
  ...
  iEvent.getByToken(triggerNameTreeToken_, triggerNameTreeHandle);
  iEvent.getByToken(METBitTreeToken_, METBitTreeHandle);
  iEvent.getByToken(METNameTreeToken_, METNameTreeHandle);
  ...
  if(!Puppi){
    ...
    iEvent.getByToken(ak8CHSjetMassToken_, ak8CHSjetMassHandle);
    ...
    iEvent.getByToken(ak8CHSjetmuonEnergyFracToken_, ak8CHSjetmuonEnergyFracHandle);
    ...
    iEvent.getByToken(ak4CHSjetMassToken_, ak4CHSjetMassHandle);
    ...
    iEvent.getByToken(ak4CHSjetmuonEnergyFracToken_, ak4CHSjetmuonEnergyFracHandle);
  ...
  if(Puppi){
    ...
    iEvent.getByToken(ak8PuppijetMassToken_, ak8PuppijetMassHandle);
    ...
    iEvent.getByToken(ak8PuppijetmuonEnergyFracToken_, ak8PuppijetmuonEnergyFracHandle);
    ...
    iEvent.getByToken(ak4PuppijetMassToken_, ak4PuppijetMassHandle);
    ...
    iEvent.getByToken(ak4PuppijetmuonEnergyFracToken_, ak4PuppijetmuonEnergyFracHandle);
  ...
  for (unsigned int i = 0; i < METNameTreeHandle->size(); i++){
    if ( std::find( filterFlags.begin(), filterFlags.end(), (*METNameTreeHandle)[i] ) != filterFlags.end() ) {
  ...
  if (MET_filters){
    ...
    if (Signal_MC){
      genTreeVars["GenID"] = (*PartIDHandle);
      genTreeVars["Daughter0ID"] = (*PartDau0IDHandle);
      genTreeVars["Daughter1ID"] = (*PartDau1IDHandle);
      hadTreeVars["GenID"] = (*PartIDHandle);
      hadTreeVars["Daughter0ID"] = (*PartDau0IDHandle);
      hadTreeVars["Daughter1ID"] = (*PartDau1IDHandle);
      genTreeVars["Mom0ID"] = (*PartMom0IDHandle);
      genTreeVars["Mom1ID"] = (*PartMom1IDHandle);
      hadTreeVars["Mom0ID"] = (*PartMom0IDHandle);
      hadTreeVars["Mom1ID"] = (*PartMom1IDHandle);
	...
	if ((*triggerBitTreeHandle)[i] == 1){
      ...
      if((*triggerNameTreeHandle)[i].find("Mu") !=string::npos){
        if ((*triggerBitTreeHandle)[i] == 1){
          Any_Mu_Count = 1;
        }
      }
    ...
    run_num = (*evtInfoRunNumberHandle);
    Event_Number = run_num;
    if (!Puppi){
	...
	if (((*ak8CHSjetPtHandle)[0] > 180) && ((*ak8CHSjetPtHandle)[1] > 180) && ((*ak8CHSjetEtaHandle)[0] < 2.4) && ((*ak8CHSjetEtaHandle)[1] < 2.4)){
	  ...
	  hadTreeVars[("jetak8RawMassCHS")] = (*ak8CHSjetMassHandle);
	  ...
	  hadTreeVars[("jetak4RawMassCHS")] = (*ak4CHSjetMassHandle);
	...
	if (((*ak8PuppijetPtHandle)[0] > 180) && ((*ak8PuppijetPtHandle)[1] > 180) && ((*ak8PuppijetEtaHandle)[0] < 2.4) && ((*ak8PuppijetEtaHandle)[1] < 2.4)){
	  ...
	  hadTreeVars[("jetak8RawMassPuppi")] = (*ak8PuppijetMassHandle);
	  ...
	  hadTreeVars[("jetak4RawMassPuppi")] = (*ak4PuppijetMassHandle);
